...
namespace ArcGISRuntime.UWP.Samples.FeatureLayerRenderingModeMap
{
    ...
    public partial class FeatureLayerRenderingModeMap
    {
        ...
        private readonly Viewpoint _zoomOutPoint = new Viewpoint(new MapPoint(-118.37, 34.46, SpatialReferences.Wgs84), 650000, 0);
        private readonly Viewpoint _zoomInPoint = new Viewpoint(new MapPoint(-118.45, 34.395, SpatialReferences.Wgs84), 50000, 90);
